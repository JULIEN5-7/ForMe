 ...
 */
class getJulienControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\JulienController' shared autowired service.
     *
     * @return \App\Controller\JulienController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'JulienController.php';

        $container->services['App\\Controller\\JulienController'] = $instance = new \App\Controller\JulienController();
        ...
        ]))->withContext('App\\Controller\\JulienController', $container));
